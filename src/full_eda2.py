...
sbac = sbac[['County Code', 'Grade', 'Test Id', 'Students Tested', 'Met or Above']].drop_duplicates()
...
teacher = teacher[['District Name', 'avg', 'Co']].drop_duplicates()
...
test1 = district_sbac.reset_index().set_index('District Name').join(teacher, how = 'inner')