...
sbac = sbac[['County Code', 'School Code', 'Subgroup ID', 'Grade', 'Test Id', 'Students Tested', 'Met or Above']] 


#---- DISTRICT CODES
#import districts and clean
district = pd.read_csv("../data/districts.csv") 
district = district[['County Code', 'County Name', 'District Name']]
...
full = full.drop_duplicates(subset=['County Code','District Code', 'School Code', 
                        ...
                        'Meclear
                        t or Above'], keep="first", inplace=False)

#----   FULL DF WITH SPECIFIC TESTS
